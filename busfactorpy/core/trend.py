...
class TrendAnalyzer:
    ...
    def analyze(self, start_date: datetime, end_date: datetime, window_days: int, step_days: int):
        results = []
        ...
        while current_date <= end_date:
            ...
            mask = (self.commit_data['date'] >= window_start) & (self.commit_data['date'] <= current_date)
            ...
            if not window_data.empty:
                ...
                if total_files > 0:
                    if 'Bus Factor' in bf_results.columns:
                        ...
                        risky_count = len(bf_results[bf_results['risk_class'] == 'Critical'])
                ...
                results.append({
                    ...
                    'risky_percentage': (risky_count / total_files * 100) if total_files > 0 else 0,
                })
